...
IMAGE_PATH = '.../data/DAGM/Train/Images/'
MASK_PATH = '.../data/DAGM/Train/Labels/' 
...
t_untrain = A.Compose([A.Resize(256, 256, interpolation=cv2.INTER_NEAREST), A.HorizontalFlip(p=0.4), A.VerticalFlip(p=0.3), 
                       A.GaussNoise(p = 0.3), 
                       A.RandomBrightnessContrast((0,0.5),(0,0.5)),
                       A.Blur(p = 0.3)])
...
unlabeled_train_set = DAGM_Dataset(IMAGE_PATH, MASK_PATH, X_untrain, mean, std, t_untrain, patch=False)
