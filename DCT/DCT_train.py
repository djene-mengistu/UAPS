    ...
    def run(self):
        ...
        for epoch in range(1, epochs):
            ...
            for iteration in range (1, iter_per_epoch): #(zip(train_loader, unlabeled_train_loader)):
                ...
                consistency_loss = torch.mean((unlabeled_rot_outputs_soft - torch.rot90(un_outputs_soft, rot_times, [2,3]))**2)
            ...
            if self.save_best_model_1:
                ...
                torch.save(state_1, Checkpoints_Path + '/DCT_10p.pth')
