...
# from loss import loss_sup, loss_adversarial_1, loss_adversmarial_2, make_Dis_label, gt_label, loss_diff
...
iter_per_epoch = 20 #Set accordingly
    ...
    def run(self):
        ...
        for epoch in range(1, epochs):
            ...
            for iteration in range (1, iter_per_epoch): #(zip(train_loader, unlabeled_train_loader)):
                ...
                consistency_weight = get_current_consistency_weight(iter_num // 40) #Consistency weight multipliers
            ...
            if self.save_best_model_1:
                ...
                torch.save(state_1, Checkpoints_Path + '/UAPS_KoSDD2_40p.pth')
